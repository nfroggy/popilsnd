...
int main(int argc, char **argv) {
	...
	getSoundData(3, "editorPlace", 12);
	getSoundData(4, "editorError", 12);
	...
	getSoundData(13, "editorChange", 12);
	getSoundData(14, "editorMove", 12);
	...
	getSoundData(31, "highScoreEntry", 12);
	getSoundData(32, "highScoreEntryDone", 12);
