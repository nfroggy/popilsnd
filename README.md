...
I had been working on re-inserting music from the Game Gear version of Popils into the NES version on the split branch of this repo, but [someone else](https://romhackplaza.org/romhacks/magical-puzzle-popils-prototype-audio-recreation-nes/) finished doing this before I did. I'm just impressed that there's someone else who cares about Popils. Check out that branch if you're interested in how the Game Gear Popils sound engine differs from the NES version.
